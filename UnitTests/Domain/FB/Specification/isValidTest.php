...
require_once dirname(__FILE__) . '/../../../../Domain/FB/Object/fb.php';
 ...
 */
class isValidTest_fb extends \PHPUnit_Framework_TestCase {
    ...
    {
        $this->isValid = new \lwMembersearch\Domain\FB\Specification\isValid();        
    }
    ...
    public function getMockObject()
    {
         ...
         *  );
         */
        return $this->getMock("\\lwMembersearch\\Domain\\FB\\Object\\fb", array(), array(), "", false);
    }
}